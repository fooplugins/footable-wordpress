...
//FooTable WordPress helper functions
jQuery.fn.attrAppendWithComma=function(e,t){var n;return this.each(function(){n=jQuery(this),void 0!==n.attr(e)&&""!=n.attr(e)?n.attr(e,n.attr(e)+","+t):n.attr(e,t)})};jQuery.fn.footableAttr=function(e,t){return this.each(function(){var n=jQuery(this);if(n.data("auto-columns")!==false){n.find("thead th:gt("+e+")").attrAppendWithComma("data-hide","tablet");n.find("thead th:gt("+t+")").attrAppendWithComma("data-hide","phone")}})};jQuery.fn.footableFilter=function(e){return this.each(function(){var t=jQuery(this);if(!t.data("filter")&&t.data("filter")!==false){t.data("filter-text-only","true").before('<div class="footable-filter-container"><input placeholder="'+e+'" style="float:right" type="text" class="footable-filter" /></div>')}})};jQuery.fn.footablePager=function(){return this.each(function(){var e=jQuery(this);if(e.find(".pagination").length)return;if(e.data("page")!==false){var t=jQuery('<tfoot class="hide-if-no-paging"><tr><td><div class="pagination pagination-centered"></div></td></tr></tfoot>');t.find("td").attr("colspan",e.find("thead th").length);e.find("tbody:last").after(t)}})}